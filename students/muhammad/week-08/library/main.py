...
from exceptions import BookNotFoundError, LoanNotFoundError, AuthorNotFoundError
from exception_handlers import book_not_found_error_handler, author_not_found_error_handler, loan_not_found_error_handler
